function Locked({ size }: { size: number }) {
  return (
    <svg height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M12 15.1875C12.5178 15.1875 12.9375 14.7678 12.9375 14.25C12.9375 13.7322 12.5178 13.3125 12 13.3125C11.4822 13.3125 11.0625 13.7322 11.0625 14.25C11.0625 14.7678 11.4822 15.1875 12 15.1875Z"
        fill="currentColor"
      />
    </svg>
  )
